...
include'config.php';
    ...
    if(isset($_GET['edit'])){
      $id=$_GET['edit'];
      $sql = "SELECT * FROM guruu WHERE id_guru='$id';";
...
<label for="jenis_kelamin" class="form-label">Jenis Kelamin:</label><br>
  <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if($jeniskelamin == 'laki-laki'){echo "checked";}?> value="laki-laki">
  <label class="form-check-label" for="laki-laki">Laki-Laki</label><br>
  <input class="form-check-input" type="radio" name="jenis_kelamin" <?php if($jeniskelamin == 'perempuan'){echo "checked";}?> value="perempuan">
